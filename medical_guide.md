...
1. [Click here](https://salut.gencat.cat/pls/rca/RCAPKTSI.SOLICITAR_TSI) and complete the form.

2. Select the corresponding option with step 2 (Datos personales II and Tipo de Seguro). **Select *CatSalut* if you’re a foreigner**.

3. Fill the information regarding your address and your contact details.

4. (Datos de la TSI): select the one that matches your situation.

5. (Confirmación): attach a copy of your *empadronamiento* (if necessary) and then click on proceed to complete the registration process.
