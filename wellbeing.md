...
[:page_facing_up: Psychological support serivices](psychological_support.html)
...
Link to registration and further info: http://bvprbb.org/information
...
Link: https://ellipse.prbb.org/tag/prbbwellbeing-2/
...
- **Rented home**:
    ...
    - Expired tenancy agreement which is extended (with no explicitly stated extension clause)
        ...
        are not), in the name of the tenant and within the last three months.
        The same coding as in the tenancy agreement must be shown.
    ...
    - Open-ended agreement, as long as four years or more have elapsed since the agreement came into force:
        - Last receipt for rent, paid within the last two months, which must show full details identifying the let.
        - Last bill or bank slip for utilities (electricity, water and gas),
        in the name of the tenant and within the last three months. The same
        coding as in the tenancy agreement must be shown. Mobile phone and
        Internet access contracts are not accepted.
        - Bank transfer, which must show the details needed to identify the rental.
    ...
    agreement came into force:
        ...
        **Online:**
        ...
        system’s Public Use Hospitals Network (XHUP).
        ...
        These hospitals offer excellent emergency services and elective and 
        non-elective medical treatment. They have some of the best medical 
        ...
        available and shorter waiting times for visits and treatments.
        
        Mutual insurance companies (insurers) have their own network of 
        hospitals, clinics and laboratories and offer some services that the 
        public system does not cover.
        
        Note that most companies only cover the care offered by the 
        professionals who appear on the lists of their medical directories, 
        ...
        Bear in mind that there are duty pharmacies that are open throughout 
